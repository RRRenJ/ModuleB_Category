...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/RRRenJ/ModuleB_Category"
  ...
  s.source       = { :git => "https://github.com/RRRenJ/ModuleB_Category.git", :tag => s.version.to_s }
  ...
  s.source_files  = "ModuleB_Category/ModuleB_Category/**/*.{h,m,swift}"
